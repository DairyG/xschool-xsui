...
DEFFLD = {
	...
	item_checkbox: '<li><input name="CHKED" value="1" class="checkbox" type="checkbox" title="默认选中此项" /><input name="VAL" type="text" class="sl"/><a class="icononly-add iconfont icon-pos" title="添加一个新的选择项">&#xe60b;</a><a class="icononly-del iconfont icon-pos" title="删除此选择项">&#xe619;</a><a class="icononly-mov iconfont icon-pos" title="排序">&#xe63d;</a></li>',
	...
	item_radio: '<li><input name="CHKED" value="1" class="radio" type="radio" title="默认选中此择项" /><input name="VAL" type="text" class="sl"/><a class="icononly-add iconfont icon-pos" title="添加一个新的选择项">&#xe60b;</a><a class="icononly-del iconfont icon-pos" title="删除此选择项">&#xe619;</a><a class="icononly-mov iconfont icon-pos" title="排序">&#xe63d;</a></li>',
    ...
    date: {
		html: '<label class="desc"><span class="req hide"> *</span></label><div class="content textcontent"><input type="text" disabled="disabled" maxlength="255" class="input"/><i class="iconfont qrinput hide">&#xe67d;</i></div>',
        json: '({LBL:"日期",TYP:"date",REQD:"0",UNIQ:"0",SCU:"pub",FMT:"date",DEF:"",INSTR:"",CSS:"",DRANGE:"0"})',
...
function setPropertieValues(c,i) {
...
function propertyInit() {
    ...
    $('#btnItemsPredefine').click(function () {
        ...
        $.lightBox({
            url: '../public/formdesign/predefinechoices.html',
            size: 's',
            confirm: function () {
                A('radio');
                CHANGED = true
    ...
    $('#btnItemsBatch').click(function () {
        ...
        $.lightBox({
            url: '../public/formdesign/itembatchedit.html',
            size: 's',
            confirm: function () {
                A(F[IDX].TYP);
	...
	$('#drange').click(function () {
	    F[IDX].DRANGE = $(this).prop('checked') ? '1' : '0';
	    CHANGED = true
	});
    $('#uniq').click(function () {
...
function addFieldsInit() {
    ...
    $('#preview').click(function () {
		var data = { formData: M, parameterData: F };
